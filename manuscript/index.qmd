...
```
For full recovery of these preliminary results run on the version from git commit [`67d5072`](https://github.com/CDCgov/Rt-without-renewal/commit/67d50727e5208e874423ed593ff506b3006efc63).
