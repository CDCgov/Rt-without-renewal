...
@testset "generate_quantiles_for_targets tests" begin
    output = Dict("inference_results" => Dict("generated" => [1, 2, 3], "samples" => Dict(:init_incidence => [0.1, 0.2, 0.3])))
    D = EpiData()
    qs = [0.25, 0.5, 0.75]
    expected_output = [[0.1 0.2 0.3; 0.1 0.2 0.3; 0.1 0.2 0.3], [0.1 0.2 0.3; 0.1 0.2 0.3; 0.1 0.2 0.3], [0.1 0.2 0.3; 0.1 0.2 0.3; 0.1 0.2 0.3]]
