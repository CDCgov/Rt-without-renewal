...
# ╔═╡ 619b6a45-b202-47f3-97cf-1ab487278674
safe_inference_mdl = fix(
    make_epi_aware(truth_data, time_horizon, Val(:safe_mode); epi_model = epi_model,
        latent_model = rwp, observation_model = obs_model),
    (rw_init = 0.0,)
)

# ╔═╡ 7da045fc-49ba-4a9a-8e5a-f9edb6418f7a
mpf = multipathfinder(safe_inference_mdl, 50; nruns = 4)

# ╔═╡ 3224f468-63d4-483a-ac65-1a584d23d92c
init_params = collect.(eachrow(mpf.draws_transformed.value[1:4, :, 1]))
